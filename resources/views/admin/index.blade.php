						...
						<div class="card-body">
							<div class="d-flex align-items-center">
								<div>
									...
									<h4 class="my-1 text-info">{{ count($project) }}</h4>
				   ...
				   <div class="col">
					<div class="card radius-10 border-start border-0 border-4 border-danger">
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   <p class="mb-0 text-secondary">Total Project Type</p>
								   <h4 class="my-1 text-danger">{{ count($projecttype) }}</h4>
					   ...
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   ...
								   <h4 class="my-1 text-success">{{ count($team) }}</h4>
					   ...
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   ...
								   <h4 class="my-1 text-warning">{{ count($service) }}</h4>
