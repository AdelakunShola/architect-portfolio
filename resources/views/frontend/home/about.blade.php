                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-5 col-sm-12 text-uppercase text-black">
                                ...
                                <p class="text-lowercase">typefaces and layouts, and in appearance of different general the content of dummy text is nonsensical.typefaces and layouts, different general the content of dummy text is nonsensical.
                                </p>
                                    ...
                                    <div class="owl-carousel home-carousel-1 owl-btn-vertical-center">
                                        ...
                                        <div class="item">
                                            <div class="ow-img wt-img-effect zoom-slow">
                                                <a href="javascript:void(0);"><img src="{{asset('frontend/assets/images/gallery/pic1.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 2 -->
                                        <div class="item">
                                            <div class="ow-img wt-img-effect zoom-slow">
                                                <a href="javascript:void(0);"><img src="{{asset('frontend/assets/images/gallery/pic2.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 3 -->
                                        <div class="item">
                                            <div class="owl-img wt-img-effect zoom-slow">
                                                <a href="javascript:void(0);"><img src="{{asset('frontend/assets/images/gallery/pic3.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 4 -->
                                        <div class="item">
                                            <div class="ow-img wt-img-effect zoom-slow">
                                                <a href="javascript:void(0);"><img src="{{asset('frontend/assets/images/gallery/pic4.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 5 -->
                                        <div class="item">
                                            <div class="ow-img wt-img-effect zoom-slow">
                                                <a href="javascript:void(0);"><img src="{{asset('frontend/assets/images/gallery/pic5.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
