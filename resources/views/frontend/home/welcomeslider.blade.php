@php
   ...
   $homeslide = App\Models\Homepage::find(1);
   $multi_image = App\Models\HomeSlide::latest()->get();

   $shortTitle = $homeslide->short_title;
   $shortDesc = $homeslide->short_desc;
            ...
            <div id="welcome_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="goodnews-header" data-source="gallery" style="background:#eeeeee;padding:0px;">
                <div id="welcome" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
                    <ul>
                        ...
                        <!-- SLIDE 1 -->
                        <li data-index="rs-901" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="{{ asset('/'.$image->multi_image) }}"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="300" data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="{{ asset('/'.$image->multi_image) }}"  alt=""  data-lazyload="{{ asset('/'.$image->multi_image) }}" data-bgposition="center center" 
                            ...
                            <div class="tp-caption BigBold-Title   tp-resizeme" 
                                ...
                                color:#fff;"><span class="text-yellow">{{ $shortTitle }} </span>  </div>
